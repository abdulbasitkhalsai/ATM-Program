...
if (pinAnswer.pin === myPin) {
    ...
    if (transType.transType === "Balance Inquiry") {
        ...
        {
            if (transAmount.amountWithdrawl === "500") {
                console.log(`Please receive cash Rs. ${transAmount.amountWithdrawl}. Now you current Balance is ${myBalance - 500}.`);
            }
            else if (transAmount.amountWithdrawl === "1000") {
